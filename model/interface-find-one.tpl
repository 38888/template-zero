...
FindPageListByPage(ctx context.Context,data *entity.{{.upperStartCamelObject}}, page, pageSize int, orderBy string, isDesc bool) ([]*entity.{{.upperStartCamelObject}},int64, error)